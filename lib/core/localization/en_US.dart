const Map<String, String> enUS = {
  ...
  'invalid_label_data': 'Invalid label data',
  'label_created_successfully': 'Label created successfully',
  'label_updated_successfully': 'Label updated successfully',
  'label_deleted_successfully': 'Label deleted successfully',
  'label_restored_successfully': 'Label restored successfully',
  'label_permanently_deleted_successfully': 'Label permanently deleted successfully',
  'labels_created_successfully': 'Labels created successfully',
  'labels_deleted_successfully': 'Labels deleted successfully',
  'error_creating_label': 'Error creating label',
  'error_loading_label': 'Error loading label',
  'error_loading_labels': 'Error loading labels',
  'error_loading_deleted_labels': 'Error loading deleted labels',
  'error_updating_label': 'Error updating label',
  'error_deleting_label': 'Error deleting label',
  'error_restoring_label': 'Error restoring label',
  'error_permanently_deleting_label': 'Error permanently deleting label',
  'error_searching_labels': 'Error searching labels',
  'error_loading_labels_by_color': 'Error loading labels by color',
  'error_loading_label_stats': 'Error loading label statistics',
  'error_duplicating_label': 'Error duplicating label',
  'error_creating_labels': 'Error creating labels',
  'error_deleting_labels': 'Error deleting labels',
  'error_cleaning_up_labels': 'Error cleaning up labels',
  ...
  'label_already_assigned_to_card': 'Label already assigned to card',
  'label_not_assigned_to_card': 'Label not assigned to card',
  'label_assigned_to_card_successfully': 'Label assigned to card successfully',
  'label_removed_from_card_successfully': 'Label removed from card successfully',
  'all_labels_removed_from_card_successfully': 'All labels removed from card successfully',
  'label_assignment_restored_successfully': 'Label assignment restored successfully',
  'label_assignment_permanently_deleted_successfully': 'Label assignment permanently deleted successfully',
  'labels_assigned_to_card_successfully': 'Labels assigned to card successfully',
  'labels_removed_from_card_successfully': 'Labels removed from card successfully',
  'card_labels_updated_successfully': 'Card labels updated successfully',
  'error_assigning_label_to_card': 'Error assigning label to card',
  'error_removing_label_from_card': 'Error removing label from card',
  'error_loading_card_labels': 'Error loading card labels',
  'error_loading_cards_by_label': 'Error loading cards by label',
  'error_loading_card_label': 'Error loading card label',
  'error_removing_all_labels_from_card': 'Error removing all labels from card',
  'error_restoring_label_assignment': 'Error restoring label assignment',
  'error_permanently_deleting_label_assignment': 'Error permanently deleting label assignment',
  'error_loading_label_usage_stats': 'Error loading label usage statistics',
  'error_assigning_labels_to_card': 'Error assigning labels to card',
  'error_removing_labels_from_card': 'Error removing labels from card',
  'error_updating_card_labels': 'Error updating card labels',
  'error_toggling_label_assignment': 'Error toggling label assignment',
  'error_loading_all_card_labels': 'Error loading all card labels',
  'error_cleaning_up_label_assignments': 'Error cleaning up label assignments',
  'no_labels_to_copy': 'No labels to copy',
  'no_labels_to_move': 'No labels to move',
  'error_copying_labels_to_card': 'Error copying labels to card',
  'error_moving_labels_to_card': 'Error moving labels to card',
  'label_assignments_removed': 'label assignments removed',
  ...
  'clean_old_items': 'Clean Old Items',
  'trash_is_empty': 'Trash is Empty',
  'no_deleted_items': 'No Deleted Items',
  'search_in_trash': 'Search in trash...',
  'no_search_results': 'No Results Found',
  'clear_trash_search': 'Clear Search',
  'show_all': 'Show All',
  'total_deleted_items': 'Total deleted items',
  'item_restored': 'Item restored successfully',
  'item_permanently_deleted': 'Item permanently deleted',
  'confirm_permanent_delete': 'Are you sure you want to permanently delete this item?',
  'confirm_empty_trash': 'Are you sure you want to empty the trash?',
  'confirm_clean_old_items': 'Clean items older than specified days?',
  'items_emptied_from_trash': 'items permanently deleted from trash',
  'old_items_cleaned': 'old items cleaned from trash',
  'no_old_items_to_clean': 'No old items to clean',
  'deleted_ago': 'Deleted',
  ...
  'trash_list': 'List',
  'trash_card': 'Card',
  'trash_checklist': 'Checklist',
  'trash_checklist_item': 'Checklist Item',
  'trash_label': 'Label',
  'trash_boards': 'Boards',
  'trash_lists': 'Lists',
  'trash_cards': 'Cards',
  'trash_checklists': 'Checklists',
  'trash_checklist_items': 'Checklist Items',
  'trash_labels': 'Labels',
  'trash_all': 'All',
  'trash_days': 'days',
  'trash_hours': 'hours',
  'trash_minutes': 'minutes',
  'trash_now': 'now',
  'trash_ago': 'ago',
  'trash_since': 'since',
  ...
  'attachment_restored': 'Attachment restored successfully',
  ...
  'delete_old_activity': 'Delete Old Activity',
  'activity_cleared': 'Activity cleared successfully',
  'old_activity_deleted': 'Old activity deleted successfully',
  ...
  'confirm_clear_activity': 'Are you sure you want to clear all activity logs?',
  'confirm_delete_old_activity': 'Are you sure you want to delete old activity logs?',
  ...
  'error_adding_attachment': 'Error adding attachment',
